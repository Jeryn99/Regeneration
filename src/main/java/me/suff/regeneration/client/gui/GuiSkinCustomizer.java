...
public class GuiSkinCustomizer extends GuiContainer {
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		...
		drawCenteredString(Minecraft.getInstance().fontRenderer, new TextComponentTranslation("regeneration.gui.preference_model", choices.name()).getUnformattedText(), width / 2, height / 2 + 15, Color.WHITE.getRGB());
