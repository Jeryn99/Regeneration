...
public class RegenClassTransformer implements IClassTransformer, Opcodes {
    ...
    private static final String REGEN_HOOKS_CLASS = "me/suff/mc/regen/asm/RegenClientHooks";
        ...
        for (MethodNode method : classNode.methods) {
            if (method.name.equals("play")) {
                RegenerationPlugin.insertBefore(method.instructions, RegenerationPlugin.invoke(SOURCE_LWJGL_NAME, "checkPitch"::equals), () -> {
                    ...
                    instructions.add(new MethodInsnNode(INVOKESTATIC, "me/suff/mc/regen/asm/SoundReverbHandler", "onPlaySound", "(I)V", false));
                    return instructions;
                });
            }
        }
