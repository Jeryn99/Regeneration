...
public class ModifiedPlayerModel extends PlayerModel {
    public ModifiedPlayerModel(ModelPart p_170821_, boolean p_170822_) {
        super(p_170821_, p_170822_);
    }

    public static LayerDefinition createMesh(CubeDeformation p_170826_) {
