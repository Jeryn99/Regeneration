...
public class RegenerationConeModel extends HumanoidModel<LivingEntity> {
    ...
    public void renderHead(PoseStack matrixStack, VertexConsumer buffer, int packedLight, int packedOverlay) {
        Head.render(matrixStack, buffer, packedLight, packedOverlay);
    }

    public void renderRightArm(PoseStack matrixStack, VertexConsumer buffer, int packedLight, int packedOverlay) {
        RightArm.render(matrixStack, buffer, packedLight, packedOverlay);
    }

    public void renderLeftArm(PoseStack matrixStack, VertexConsumer buffer, int packedLight, int packedOverlay) {
        LeftArm.render(matrixStack, buffer, packedLight, packedOverlay);
    }
