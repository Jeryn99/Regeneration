...
import me.suff.mc.regen.common.block.ArchBlock;
import me.suff.mc.regen.common.block.BlockHandInJar;
import me.suff.mc.regen.common.block.ZeroRoomBlock;
import me.suff.mc.regen.common.dimension.DimSingle;
import me.suff.mc.regen.common.dimension.GallifreyChunkGenerator;
import me.suff.mc.regen.common.dimension.GallifreyDimension;
import me.suff.mc.regen.common.dimension.biomes.*;
import me.suff.mc.regen.common.dimension.features.FeatureSpikeyBoys;
import me.suff.mc.regen.common.dimension.features.GallifreyanHuts;
import me.suff.mc.regen.common.dimension.features.GallifreyanTreeFeature;
import me.suff.mc.regen.common.dimension.features.SkullFeature;
...
import me.suff.mc.regen.util.common.RegenDamageSource;
...
public class RegenObjects {
    ...
    public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
        event.getRegistry().register(WorldGenEntries.TREES.setRegistryName(Regeneration.MODID, "trees"));
        event.getRegistry().register(WorldGenEntries.SPIKEYS.setRegistryName(Regeneration.MODID, "spikeys"));
        event.getRegistry().register(WorldGenEntries.SKULLS.setRegistryName(Regeneration.MODID, "skulls"));
        event.getRegistry().register(WorldGenEntries.HUT.setRegistryName(Regeneration.MODID, "huts"));
    }
    ...
    public static void addSpawns(FMLLoadCompleteEvent e) {
        if (RegenConfig.COMMON.spawnTimelords.get()) {
    ...
    private static SoundEvent setUpSound(String soundName) {
        return new SoundEvent(new ResourceLocation(Regeneration.MODID, soundName));
    }
