...
public class RWorldHelper {


    public static ConfiguredStructureFeature<?, ?> CONFIGURED_HUTS = RFeatures.TIMELORD_HUTS.get()
    ...
    public static void registerConfiguredStructures() {
        ...
        Registry.register(registry, new ResourceLocation(RConstants.MODID, "timelord_hut"), CONFIGURED_HUTS);
    }
        ...
        if (event.getWorld() instanceof ServerLevel serverLevel) {
            ...
            for (Map.Entry<ResourceKey<Biome>, Biome> biomeEntry : serverLevel.registryAccess().ownedRegistryOrThrow(Registry.BIOME_REGISTRY).entrySet()) {
                ...
                if (biomeCategory != Biome.BiomeCategory.OCEAN && biomeCategory != Biome.BiomeCategory.THEEND && biomeCategory != Biome.BiomeCategory.NETHER && biomeCategory != Biome.BiomeCategory.NONE) {
                    associateBiomeToConfiguredStructure(angelStructures, CONFIGURED_HUTS, biomeEntry.getKey());
                }
            }
            ...
            try {
                ...
                Regeneration.LOG.error("Was unable to check if " + serverLevel.dimension().location() + " is using Terraforged's ChunkGenerator.");
            }
            ...
            tempMap.putIfAbsent(RFeatures.TIMELORD_HUTS.get(), StructureSettings.DEFAULTS.get(RFeatures.TIMELORD_HUTS.get()));
