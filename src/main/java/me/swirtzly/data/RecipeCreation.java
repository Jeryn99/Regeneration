...
public class RecipeCreation extends RecipeProvider {
    ...
    protected void registerRecipes(Consumer<IFinishedRecipe> consumer) {
        ...
        //Furnace
        CookingRecipeBuilder.smeltingRecipe(Ingredient.fromItems(RegenObjects.Blocks.GAL_ORE.get()), RegenObjects.Items.GAL_INGOT.get(), 3.1F, 150);
        CookingRecipeBuilder.blastingRecipe(Ingredient.fromItems(RegenObjects.Blocks.GAL_ORE.get()), RegenObjects.Items.GAL_INGOT.get(), 3.1F, 100);
    }
}
