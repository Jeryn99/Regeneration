...
public class TypeLayFadeRenderer extends ATypeRenderer<TypeElixir> {
    ...
    @Override
    protected void onRenderRegeneratingPre(TypeElixir type, RenderPlayerEvent.Pre event, IRegeneration capability) {

    }

    @Override
    protected void onRenderRegeneratingPost(TypeElixir type, RenderPlayerEvent.Post event, IRegeneration capability) {

    }

    @Override
    protected void onRenderLayer(TypeElixir type, RenderLivingBase<?> renderLivingBase, IRegeneration capability, EntityPlayer entityPlayer, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
