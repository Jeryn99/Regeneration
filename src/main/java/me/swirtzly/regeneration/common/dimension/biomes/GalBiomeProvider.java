...
public class GalBiomeProvider extends ModdedBiomeProvider {
    ...
    public Layer wrapMappedBiomesAround(Layer parent) {
        ...
        mapping.addBiomeOverride(Biomes.FLOWER_FOREST, RBiomes.redLandsForest);
        ...
        mapping.addBiomeOverride(Biomes.MOUNTAIN_EDGE, RBiomes.redLandsForest);
        ...
        mapping.addBiomeOverride(Biomes.TALL_BIRCH_FOREST, RBiomes.redLandsForest);
        ...
        mapping.addBiomeOverride(Biomes.FOREST, RBiomes.redLandsForest);
        mapping.addBiomeOverride(Biomes.FLOWER_FOREST, RBiomes.redLandsForest);
        return mapping;
    }
