...
public class ServerReflector extends VivecraftReflector {
    ...
    public boolean init() {
        enabled = 0;
        Regeneration.LOG.info("Checking for Vivecraft Client...");
        try {
            ...
            Regeneration.LOG.info("Vivecraft Client detected! Enabling compatibility features.");
        ...
        if (enabled < 0) {
            ...
            try {
                ...
                Regeneration.LOG.info("Vivecraft Forge Extensions detected! Enabling compatability features.");
            } catch (Exception e) {
                enabled = -1;
            }
        }
        ...
        if (enabled < 0)
            Regeneration.LOG.info("Vivecraft not detected!");
    ...
    public boolean isVRPlayer(PlayerEntity player) {
        ...
        try {
            ...
            Regeneration.LOG.warn("Vivecraft Server: Unknown Error Parsing isVRPlayer", e);
        }
    ...
    public Vector3d getHMDPos(PlayerEntity player) {
        try {
            ...
            Regeneration.LOG.warn("Vivecraft Server: Unknown Error Parsing getHMDPos", e);
        }
    ...
    public Vector3d getHMDRot(PlayerEntity player) {
        try {
            ...
            Regeneration.LOG.warn("Vivecraft Server: Unknown Error Parsing getHMDRot", e);
        }
