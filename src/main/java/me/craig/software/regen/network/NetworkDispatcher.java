package me.craig.software.regen.network;
...
public class NetworkDispatcher {
    ...
    public static SimpleChannel NETWORK_CHANNEL = NetworkRegistry.newSimpleChannel(new ResourceLocation(RConstants.MODID, RConstants.MODID), () -> "1.0", "1.0"::equals, "1.0"::equals);
