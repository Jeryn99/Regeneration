...
public class TimelordSuperpowerHandler extends SuperpowerPlayerHandler {
	...
	public void onUpdate(TickEvent.Phase phase) {
		...
		if (regenTicks > 0 && regenTicks < 200) {
			...
			if (cap.getPlayer().world.isRemote && Minecraft.getMinecraft().player.getName().equals(cap.getPlayer().getName())) Minecraft.getMinecraft().gameSettings.thirdPersonView = 2;
