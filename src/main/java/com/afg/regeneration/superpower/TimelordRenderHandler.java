...
public class TimelordRenderHandler implements SuperpowerRenderer.ISuperpowerRenderer {
	...
	@Override
	public void onRenderHandEvent(RenderHandEvent e) {
		
	}
	
	@Override
	public void onRenderSpecificHandEvent(RenderSpecificHandEvent e) {
		
	}
	
	@Override
	public void onRenderFirstPersonArmRPAPI(EnumHandSide side) {
