...
public class LayerRegenerationLimbs implements LayerRenderer<EntityPlayer>
{
	...
	public void doRenderLayer(EntityPlayer player, float p_177169_2_, float p_177169_3_, float p_177169_4_, float p_177169_5_, float p_177169_6_,
			float p_177169_7_, float p_177169_8_)
	{
		...
		if(SuperpowerHandler.hasSuperpower(player, Regeneration.timelord))
		{
			...
			if(handler.regenTicks > 0)
			{
				...
				if(handler.regenTicks > 150){
					playerModelSmallArms.bipedBody.isHidden = playerModelSmallArms.bipedLeftLeg.isHidden = playerModelSmallArms.bipedRightLeg.isHidden =
							playerModelSmallArms.bipedBodyWear.isHidden = playerModelSmallArms.bipedHeadwear.isHidden =
									playerModelSmallArms.bipedLeftLegwear.isHidden = playerModelSmallArms.bipedRightLegwear.isHidden = false;

					playerModelLargeArms.bipedBody.isHidden = playerModelLargeArms.bipedLeftLeg.isHidden = playerModelLargeArms.bipedRightLeg.isHidden =
							playerModelLargeArms.bipedBodyWear.isHidden = playerModelLargeArms.bipedHeadwear.isHidden =
									playerModelLargeArms.bipedLeftLegwear.isHidden = playerModelLargeArms.bipedRightLegwear.isHidden = false;
				} else {
					playerModelSmallArms.bipedBody.isHidden = playerModelSmallArms.bipedLeftLeg.isHidden = playerModelSmallArms.bipedRightLeg.isHidden =
							playerModelSmallArms.bipedBodyWear.isHidden = playerModelSmallArms.bipedHeadwear.isHidden =
									playerModelSmallArms.bipedLeftLegwear.isHidden = playerModelSmallArms.bipedRightLegwear.isHidden = true;

					playerModelLargeArms.bipedBody.isHidden = playerModelLargeArms.bipedLeftLeg.isHidden = playerModelLargeArms.bipedRightLeg.isHidden =
							playerModelLargeArms.bipedBodyWear.isHidden = playerModelLargeArms.bipedHeadwear.isHidden =
									playerModelLargeArms.bipedLeftLegwear.isHidden = playerModelLargeArms.bipedRightLegwear.isHidden = true;
				}
			}
		}
