...
public record BiomeFeatureModifier(HolderSet<Biome> biomes, GenerationStep.Decoration generationStage,
    ...
    public static final ResourceLocation ADD_FEATURE = new ResourceLocation(RConstants.MODID, "feature_add");
    public static final String ORE_NAME = "zinc_ore";

    private static final RegistryObject<Codec<? extends BiomeModifier>> SERIALIZER = RegistryObject.create(ADD_FEATURE, ForgeRegistries.Keys.BIOME_MODIFIER_SERIALIZERS, RConstants.MODID);
