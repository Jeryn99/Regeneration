...
public class TestFobWatch {
	...
	private void setup(boolean sneaking, boolean creative) {
		...
		player = mock(EntityPlayer.class); //setup player mock
		player.world = world;
		...
		capability = mock(CapabilityRegeneration.class); //setup capability mock
		...
		watchStack = mock(ItemStack.class); //setup stack mock
