package mc.craig.software.regen.client.rendering.entity;// Made with Blockbench 4.7.2
...
public class CybermanModel extends HumanoidModel<Cyberman> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition RightArm = partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(40, 16).addBox(-2.0F, -2.0F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(52, 71).addBox(-2.0F, -2.0F, -2.0F, 3.0F, 5.0F, 4.0F, new CubeDeformation(0.6F)), PartPose.offset(-5.0F, 2.0F, 0.0F));
