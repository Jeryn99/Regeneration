    ...
    public static void renderUi(GuiGraphics guiGraphics) {
       ...
       /*    if(Minecraft.getInstance().options.getCameraType() == CameraType.FIRST_PERSON){
            ...
            if (currentState == RegenStates.REGENERATING) {
                ...
                if (timeString != null) {
                    Minecraft.getInstance().font.drawInBatch(timeString, 21, 8, ChatFormatting.WHITE.getColor(), true, Transformation.identity().getMatrix(), renderImpl, Font.DisplayMode.NORMAL, 0, 15728880);
                }
                renderImpl.endBatch();
            }
